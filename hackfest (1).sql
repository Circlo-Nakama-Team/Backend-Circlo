...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 15, 2024 at 09:50 PM
...
INSERT INTO `address` (`ADDRESSID`, `USERID`, `ADDRESS`, `DETAIL_ADDRESS`, `TITLE`) VALUES
('address-0Wy2vznU5Y', 'user-50jfWeMnSB', 'Jl. Merdeka Timur No.80, Cirebon', 'Depan bank BTN', 'Rumah'),
('address-eJC6TBarGC', 'user-50jfWeMnSB', 'Jl. Hari Sudarsono No.85, Cirebon', 'Depan Polsek', 'Rumah');
...
('post-61OfiY0kbGa7-Tw8', 'user-50jfWeMnSB', 'Lorem Ipstum Dolor', '2024-01-16 03:39:45', 0, 'https://storage.cloud.google.com/circlo-bucket/Post/Edited%20version%20of%20_The%20Great%20Wave%20off%20Kanagawa_%20[3840x2160].jpg');
...
('user-50jfWeMnSB', 'Farras', 'Harry', 'BroRas', 'bracenolimit@gmail.com', 0, 'address-0Wy2vznU5Y');
